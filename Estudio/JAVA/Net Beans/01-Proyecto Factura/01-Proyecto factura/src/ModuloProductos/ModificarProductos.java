...
public class ModificarProductos extends javax.swing.JFrame {
    ...
    private void btnRegistrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRegistrarActionPerformed
        ...
        int guardar_id = Integer.valueOf(codigo);
        int guardar_precio = Integer.valueOf(precio);
        Producto temp = new Producto(guardar_id, nombre, guardar_precio);
        
        if (!codigo.equals("") && !nombre.equals("") && !precio.equals("")) {
            boolean proceso = this.ventanaMenu.database.editarProducto(temp);
            this.ventanaMenu.setVisible(true);
