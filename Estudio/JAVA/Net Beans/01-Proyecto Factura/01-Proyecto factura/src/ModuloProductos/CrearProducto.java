...
public class CrearProducto extends javax.swing.JFrame {
    ...
    private void btnRegistrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRegistrarActionPerformed
        ...
        int precio_pro = Integer.parseInt(precio);
        
        if (!codigo.equals("") && !nombre.equals("") && !precio.equals("")) {
            boolean repetido = true;
            if (this.ventanaMenu.database.buscarProducto(id) != null){
                repetido = false;
            }
            if (repetido) {
                boolean proceso = this.ventanaMenu.database.insertarProducto(id, nombre, precio_pro);
                this.ventanaMenu.setVisible(true);
