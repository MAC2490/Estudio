...
public class EliminarProducto extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        mostrar_nombre.setEditable(false);
        mostrar_nombre.setBackground(new java.awt.Color(204, 255, 255));
        mostrar_nombre.setForeground(new java.awt.Color(0, 0, 0));
        ...
        mostrar_precio.setBackground(new java.awt.Color(204, 255, 255));
        mostrar_precio.setForeground(new java.awt.Color(0, 0, 0));
        ...
        mostrar_cantidad.setBackground(new java.awt.Color(204, 255, 255));
        mostrar_cantidad.setForeground(new java.awt.Color(0, 0, 0));
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                        .addGroup(jPanel2Layout.createSequentialGroup()
                            ...
                            .addComponent(mostrar_precio, javax.swing.GroupLayout.PREFERRED_SIZE, 289, javax.swing.GroupLayout.PREFERRED_SIZE))
                        .addGroup(jPanel2Layout.createSequentialGroup()
                            .addComponent(jLabel3)
                            .addGap(18, 18, 18)
                            .addComponent(mostrar_nombre, javax.swing.GroupLayout.PREFERRED_SIZE, 289, javax.swing.GroupLayout.PREFERRED_SIZE)))
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(mostrar_cantidad, javax.swing.GroupLayout.PREFERRED_SIZE, 289, javax.swing.GroupLayout.PREFERRED_SIZE))))
       ...
       String id = buscar_id.getText();
        ...
        for (int i = 0; i < this.ventanaMenu.contProductos; i++) {
            if (this.ventanaMenu.listaProductos[i].getId().equals(id)){
                for (int j = 0; j < this.ventanaMenu.contProductos-1; j++) {
                    this.ventanaMenu.listaProductos[i] = this.ventanaMenu.listaProductos[i+1];
                }
    ...
    public void encontrarId(String id) {
        for (int i = 0; i<this.ventanaMenu.contProductos;i++){
            ...
            if (this.ventanaMenu.listaProductos[i].getId().equals(id)) {
                this.mostrar_nombre.setText(this.ventanaMenu.listaProductos[i].getNombre());
                this.mostrar_precio.setText(precio);
                this.mostrar_cantidad.setText(cantidad);
            }
        }
    }
