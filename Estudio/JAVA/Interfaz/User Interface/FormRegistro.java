...
public class FormRegistro extends JFrame {
	...
	public FormRegistro(String titulo){
		...
		ActionListener eventoLimpiar = new ActionListener(){
			@Override
			public void actionPerformed(ActionEvent e){
				System.out.println("Se dio en limpiar");
			}
		};
		...
		ActionListener eventoGuardar = new ActionListener(){
			@Override
			public void actionPerformed(ActionEvent e){
				System.out.println("Se dio en guardar");	
			}
		};

		btn_limpiar.addActionListener(eventoLimpiar);
		btn_guardar.addActionListener(eventoGuardar);
	}
